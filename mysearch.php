...
<section class="d-flex align-items-center dark-overlay bg-cover" style="background-image: url(styles/img/nav/02.jpg);">
    ...
    <div class="container"  >
      <div class="search-bar rounded p-3 p-lg-4 position-relative mt-n5 z-index-20">
              <form action="?tab=serch" method="post">
              <div class="row">
...
<?php
// Tab 
$tab = isset($_GET['tab']) ? $_GET['tab'] : 'serch';
// Tab seting
    if($tab == 'serch'){ 
        if(isset($_POST['serchh'])){
          $name = $_POST['name'];
          $Provinces = $_POST['Provinces'];
            $sql = "SELECT * from missing where name like '%$name%' or  Provinces  like '$Provinces' ";
     ...
     //////////////////////////////////////////////////////////////////////////////////////////
              ...
              // <!-- blog item-->
                echo '<hr>'; }}
                echo"<p class='list-group-item list-group-item-action disabled text-center'>  نهاية البحث ... </p>";} ?>
<hr></div></div></div> 
