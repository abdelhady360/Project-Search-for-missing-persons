  <footer class="main-footer text-center"> 
    <strong> حقوق الملكية &copy; 2020 - 2021 <a href="#"></a>  <a href=""></a></strong>
  </footer>
<!-- ./wrapper -->
<!-- jQuery 3 -->
...
<script src="styles/bower_components/Flot/jquery.flot.pie.js"></script>
<script src="styles/bower_components/Flot/jquery.flot.categories.js"></script>
...
<script src="styles/dist/jsf/all.min.js"></script>
<!-- DataTables -->
<script src="styles/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="styles/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script>
  $(function () {
    $('#example1').DataTable()
